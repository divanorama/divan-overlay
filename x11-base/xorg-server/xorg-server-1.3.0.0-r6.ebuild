...
# $Header: /var/cvsroot/gentoo-x86/x11-base/xorg-server/xorg-server-1.3.0.0-r6.ebuild,v 1.11 2008/05/07 03:30:44 dberkholz Exp $
...
PDEPEND="
	xorg? (
		...
		video_cards_i810? ( >=x11-drivers/xf86-video-intel-1.6.0 )
